...
/* ======================================================================
   Investigation request/reply by CRJ
  ======================================================================= */
struct Invest_Request {
...
struct Hello_Message {
       int rec_info[MAX_NEIGHBOR_NUMBER];
};
...
public:
	//Added by CRJ
        ...
        int hello_mark;
	//int one_hop_neighbor[MAX_NEIGHBOR_NUMBER];
        int invest_req_mark;
        int invest_rep_mark;
        struct Invest_Request  invest_req[MAX_INVEST_RECORD];
        struct Invest_Reply    invest_rep[MAX_INVEST_RECORD];
        //End added
...
public:
	...
	inline void init() {
		...
		hello_mark = 0;
                ...
                {
                   invest_req[i].route_len = 0;
                   invest_req[i].total_packet = -1;
                   invest_rep[i].total_packet = -1;
                   invest_rep[i].route_len = 0;
                   for(int j = 0; j < MAX_ROUTE_LEN; j++)
                   {
                     invest_req[i].sr_route[j] = -1;
                     invest_rep[i].sr_route[j] = -1;
                   }
                }
             //Ended by CRJ
	}
