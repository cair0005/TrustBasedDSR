...
int w_self[MAX_NEIGHBOR_NUMBER], w_self_count;
int w_coop[MAX_NEIGHBOR_NUMBER], w_coop_count;
int b_self[MAX_NEIGHBOR_NUMBER], b_self_count;
int b_coop[MAX_NEIGHBOR_NUMBER], b_coop_count;
